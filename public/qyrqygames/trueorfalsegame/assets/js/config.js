...
var loadInitConfig = function(){
    config.maxTime= getIntNew(getText("ft-text-max-time"));
    config.statementBack='statement-back.png';
    config.trueImg= getImg("ft-true");
    config.falseImg= getImg("ft-false");
    config.timed= getBoolean(getText("ft-text-timer"));
    config.replayable= getBoolean(getText("ft-text-replayable"));
    config.questionCount= getInt(getText("ft-text-question-count"));
